...
public class FormulaTest
{
    public static void main(String args[])
    {
        try
        {
            ...
            m_view.setFormula(++rowIndex, 1 , nextFunction);
            m_view.setText(rowIndex, 2, nextFunction);
            nextFunction = "CORREL({4,7,9},{1,2,3})";
            m_view.setFormula(++rowIndex, 1 , nextFunction);
            m_view.setText(rowIndex, 2, nextFunction);
            nextFunction = "COS(5)";
            m_view.setFormula(++rowIndex, 1 , nextFunction);
            ...
            m_view.setFormula(++rowIndex, 1 , nextFunction);
            m_view.setText(rowIndex, 2, nextFunction);
            nextFunction = "HYPERLINK(\"http://www.jxcell.net\",\"java spreadsheet component\")";
            m_view.setFormula(++rowIndex, 1 , nextFunction);
            m_view.setText(rowIndex, 2, nextFunction);
            ...
            CellFormat cfm = m_view.getCellFormat();
            cfm.setCustomFormat("$#,##0.00;[Red]$#,##0.00");
            m_view.setCellFormat(cfm);
